...
3. [Requirements](#requirements)
   3.1 [Python packages](#python-packages)
4. [Input pre-processing](#input-pre-processing)
5. [Usage](#usage)
   5.1 [Basic command](#basic-command)
   5.2 [Full example](#full-example)
   5.3 [Example with optional flags and example flag arguments](#example-with-optional-flags-and-example-flag-arguments)
6. [Command line arguments](#command-line-arguments)
   6.1 [Required arguments](#required-arguments)
   6.2 [Input data files](#input-data-files)
      6.2.1 [Optional:](#optional)
   6.3 [Optional output & processing flags](#optional-output--processing-flags)
...
10. [Categories JSON file](#categories-json-file)
   10.1 [Basic structure](#basic-structure)
   10.2 [Example:](#example)
   10.3 [Important Notes](#important-notes)
11. [Conditions JSON file](#conditions-json-file)
   11.1 [Basic structure](#basic-structure-1)
   11.2 [Condition setting format](#condition-setting-format)
      11.2.1 [Values conditions](#values-conditions)
      11.2.2 [Range conditions](#range-conditions)
         11.2.2.1 [Supported operators:](#supported-operators)
      11.2.3 [String conditions](#string-conditions)
         11.2.3.1 [Match to exclude:](#match-to-exclude)
         11.2.3.2 [Multiple match conditions:](#multiple-match-conditions)
         11.2.3.3 [Special Conditions:](#special-conditions)
   11.3 [Example condition JSON](#example-condition-json)
12. [Additionally generated columns](#additionally-generated-columns)
13. [Pharmacy summary table](#pharmacy-summary-table)
   13.1 [Filtering medications displayed](#filtering-medications-displayed)
   13.2 [Filtering relative to inclusion year in qdat](#filtering-relative-to-inclusion-year-in-qdat)
14. [Diagnosis summary table](#diagnosis-summary-table)
   14.1 [Additionally displayed qdat columns](#additionally-displayed-qdat-columns)
   14.2 [Conversion analysis](#conversion-analysis)
      14.2.1 [Conversion analysis modes](#conversion-analysis-modes)
